...
export function registerPsdCompatibilityHandlers() {
    if (additionalInfo.infoHandlersMap.lfxs) return;

    additionalInfo.infoHandlersMap.lfxs = {
        read(reader: any, target: any, left: () => number, _psd: any, options: any) {
